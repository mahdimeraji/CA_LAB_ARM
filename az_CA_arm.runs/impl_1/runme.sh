...
HD_PWD='C:/Users/meraj/az_CA_arm/az_CA_arm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IF.tcl -notrace
